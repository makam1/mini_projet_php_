...
<html>
    <head>
        ...
        <title>Exclure Apprenants</title>
    </head>
    <body  >
    <div class="card text-center menu">
        ...
        <div class="card-body">
            <h2 class="card-title">Exclure Un/Des Apprenant(s) </h2>
        </div >   
                    ...
                    $promos=fopen('apprenants.txt', 'r');
                        while(!feof($promos)){
                          ...
                          echo "<tr'>";
                            ...
                            if($i==7){
                                if($tab[7]=="actif"){
                                  echo " <td><a href='exclu.php?code=$tab[0]&promo=$tab[6]'><button type='button' class='btn btn-success'>".$tab[7]."</button>
                              </a></td>";
                            }
                               if($tab[7]=="exclu"){
                               echo " <td><a href='exclu.php?code=$tab[0]&promo=$tab[6]'><button type='button' class='btn btn-danger'>".$tab[7]."</button>
                               </a></td>";
                            }
                           }
                            echo "</tr>";
