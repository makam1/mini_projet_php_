...
<div class="card text-center">
  <div class="card-header">
   ...
   <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="ajouterProduit.php">Ajouter</a>
      </li>
      <li class="nav-item">
...
<form class="form-signin" method="post" action="">
  <img class="mb-4" src="/docs/4.3/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
    ...
    <input class="formrecherche" type="text" name="nom" placeholder="Entrer le nom du produit"/>
      ...
      <input type='submit' value='Ajouter' id='rechercher' class="formrecherche"><br><br>
...
{ 
$ingredient[]=array("produits" => $nom,"prix" =>$prixsaisi, "quantites" =>$quantitesaisi , "montant" => '');
for($i=0;$i<count($ingredient);$i++){
  $taille=$ingredient[$i];
