...
<div class="card text-center">
  <div class="card-header">
   ...
   <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="rechercherProduits.php">Rechercher</a>
      </li>
      <li class="nav-item">
  ...
  <div class="card-body">
    <h5 class="card-title">RECHERCHER ICI</h5>
...
<form class="form-signin" method="post" action="">
  <img class="mb-4" src="/docs/4.3/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
    ...
    <input class="formrecherche" type="number" name="prixmin" placeholder="Entrer le prix minimum"/>
      ...
      <input type='submit' value='Rechercher' id='rechercher' class="formrecherche"><br><br>
...
$prixmax=10000000;
$quantite=10000000;
if (isset($_POST['prixmin']) && isset($_POST['prixmax']) && isset($_POST['quantite'])) {
   ...
   $quantite=$_POST['quantite'];
    ...
    $ingredient = array(
                  ...
                  array("produits" => 'oignon',"prix" => '350' , "quantites" => '25', "montant" => ''),
                  ...
                  array("produits" => 'aubergine',"prix" => '700' , "quantites" => '9', "montant" => ''),
    );

        for($i=0;$i<count($ingredient);$i++){
          $taille=$ingredient[$i];
          if($prixmin<=$taille["prix"] && $prixmax>=$taille["prix"] && $quantite<=$taille["quantites"]){
          echo"<tr>
        ...
        "; 
            ...
            if($prixmin<=$taille["prix"] && $prixmax>=$taille["prix"]  ){
              echo"<tr>
              <td>".$taille["produits"]."</td>
              <td>".$taille["prix"]."</td>
              <td>".$taille["quantites"]."</td>
