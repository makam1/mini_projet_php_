...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <a href="lister.php" class="btn btn-primary">Go</a>
  </div>
</div>
<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img src="newleg.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="newleg1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="newleg2.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
</div>
