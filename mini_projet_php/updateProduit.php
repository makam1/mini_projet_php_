...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="updateProduit.php">Update</a>
      </li>
      <li class="nav-item">
  ...
  <div class="card-body">
    <h5 class="card-title">Modifier les produits</h5>
...
<form class="form-signin" method="post" action="">
  <img class="mb-4" src="/docs/4.3/assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">
    ...
    <input class="formrecherche" type="text" name="nom" placeholder="Entrer le nom du produit"/>
      ...
      <input class="formrecherche" type="number" name="quantite" placeholder="Entrer la quantité"/>
      <input type='submit' value='Modifier' id='rechercher' class="formrecherche"><br><br>
</form>
</div>
...
if (isset($_POST['nom']) && isset($_POST['prix_unitaire'])&& isset($_POST['quantite'])) {
  $nom=$_POST['nom'];
...
for($i=0;$i<count($ingredient);$i++){
 ...
 if($exist==true)
{ 
  $ingredient[$ligne]=array("produits" => $nom,"prix" =>$prixsaisi, "quantites" =>$quantitesaisi , "montant" => '');
for($i=0;$i<count($ingredient);$i++){
  $taille=$ingredient[$i];
...
{
  //echo "  <h4 style='color:red;text-align:center'>Le produit que vous voulez modifier n'existe pas <h4>" ;
